      ...
      <div className="space-y-8 max-w-7xl mx-auto pb-12">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={fetchRows}
              className="ui-btn inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 shadow-sm text-sm font-medium transition-all"
            >
              <RefreshCw className="w-4 h-4" /> Sync
            </button>
            <button
              onClick={handleExport}
              className="ui-btn inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 shadow-sm text-sm font-medium transition-all"
            >
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="ui-card rounded-2xl border border-slate-200 bg-white p-5 shadow-sm md:col-span-2">
          ...
          <div className="ui-card rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white p-5 shadow-sm">
        ...
        <div className="ui-card bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm text-left align-middle">
              <thead className="sticky top-0 z-10 bg-slate-50/95 backdrop-blur border-b border-slate-100 text-xs uppercase font-semibold text-slate-500">
                <tr>
              ...
              <tbody className="divide-y divide-slate-100">
                {loading ? (
                  ...
                  filtered.map((r) => (
                    <tr key={r.id} className="ui-row-hover hover:bg-slate-50 transition-colors group">
